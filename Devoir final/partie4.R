...
# 3) Veuillez creer la table de données data_bank_deposit qui ne possèdera que les clients qui ont une balance strictement supérieure à 0.
...
# 5)	Pouvez interpréter la regle menant a la premiere feuille terminale 
rpart_bank_deposit
...
# 7) Veuillez déterminer le taux naturel d'erreur que nous possedons dans notre table de données data_bank_deposit. 
...
# 8)	Veuillez construire trois modèles, boosting, bagging, et foret al�eatoire tous de 50 arbres et ayant une 
