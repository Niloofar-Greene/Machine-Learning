...
# Creates corpus
docs <- Corpus(DirSource('/Users/niloo/Documents/GitHub/Machine-Learning/Text Mining/TextMiningFolder'))
inspect(docs)
...
#Stem document --> ATTENTION as it remove sometimes the suffix and prefixes that we do not want. So you have to do some clean up after
docs <- tm_map(docs, stemDocument)

#Clean up
docs <- tm_map(docs, content_transformer(gsub), pattern="posit", replacement="positive")
docs <- tm_map(docs, content_transformer(gsub), pattern="ongo", replacement="ongoing")
