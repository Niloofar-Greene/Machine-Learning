...
# G 3 distigue clairement virginica, G 1 distique setosa, G 2 est majoritairement versicolor,
# G 3 melange vraiment virginica & versicol
# il y a donc des virginica et versicolor  qui se ressemblent bq, et il y a des virginica  et versicolor  qui  sont vraiement a part
# y a des versic ki sont complement a part meme a qqe ptt erreurs
# y a des setosa bien precis
# comparer les resultsts de H et NH

table(iris$Species,iris$Cluster)
table(iris$Species,iris$Cluster_H)

# ici si on va avec k=3, ca donne pas les meme resultat que la methode NH

# si j'ai le temps et le budget, on fait Hierarchique et si on trouve k=3, apres je fais un k-menas (Non-hierarchique) avec 3 clusters
